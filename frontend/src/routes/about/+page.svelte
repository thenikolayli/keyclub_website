    ...
    <section class="space-y-[14rem] py-[10rem] w-[80%] md:w-fit mx-auto overflow-hidden">
        ...
        <div class="relative cards h-fit w-full md:flex">
            ...
            <div class="cards-info-stack absolute left-0 md:relative w-fit ml-4 overflow-hidden">
                ...
                <h1 class="cards-info text-lg flex items-center text-gray-400"><Icon icon="fe:mail" /><span
        ...
        <div class="relative cards h-fit w-full md:flex">
            ...
            <div class="cards-info-stack absolute left-0 md:relative w-fit ml-4 overflow-hidden">
                ...
                <h1 class="cards-info text-xl flex items-center text-gray-400"><Icon icon="fe:mail" /><span
...
<section class="w-full min-h-screen p-8 flex items-center flex-col text-center">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-[4rem] w-[90%] lg:w-[70%] xl:w-[60%] flex-1">
        ...
        <div class="flex flex-col h-full w-full items-center justify-center">
            ...
            <h1 class="text-2xl flex items-center text-gray-600"><Icon icon="fe:mail" /><span class="ml-2">
...
<section class="w-full h-screen p-8 flex items-center flex-col text-white">
    ...
    <div class="flex text-black gap-8 mt-4">
        <button onclick={() => loop.previous(partner_change)}>
            <Icon icon="solar:arrow-left-outline" class="size-[4rem]"/>
        </button>
        <button onclick={() => loop.next(partner_change)}>
...
<section class="w-full h-screen grid grid-cols-1 grid-rows-2 md:grid-cols-2 md:grid-rows-1">
    <div class="w-full h-full flex flex-col items-center justify-center p-8">
        ...
        <h1 class="text-3xl md:text-2xl mt-8 text-left">
...
<section class="w-full p-8 my-[4rem] text-center">
    ...
    <h1 class="mt-4 mb-8 text-3xl text-left">
